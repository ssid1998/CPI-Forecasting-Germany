...
\newcommand{\MapleCommand}[1]{{\color{MapleColor}\nolinkurl{#1}}}
\newcommand{\PYTHON}[1]{{\color{PythonColor}\nolinkurl{#1}}}
\newcommand{\SHELL}[1]{{\color{ShellColor}\nolinkurl{#1}}}
\newcommand{\FILE}[1]{{\color{FileColor}\nolinkurl{#1}}}
\newcommand{\FILELOC}[1]{{\color{FileColor}\nolinkurl{#1}}}
