...
\begin{table}[H]
	...
	\begin{tabular}{|>{\centering\arraybackslash}m{4.2cm}|m{3.5cm}|m{1.7cm}|m{3.5cm}|m{2cm}|}
		...
		\makecell{\rule{0pt}{1.0cm}\includegraphics[width=3.2cm]{../../Images/BOM_SBOM/laptop.png}} &
		...
		\makecell{\rule{0pt}{1.5cm}\includegraphics[width=3.0cm]{../../Images/BOM_SBOM/keyboard.jpeg}} &
		Keyboard. &   1    &
		...
		\makecell{\rule{0pt}{1.0cm}\includegraphics[width=3.0cm]{../../Images/BOM_SBOM/mouse.png}} &
		Mouse. &   1    &
